...
class QtEmt(QObject):
    '''
    Allows the application to speak with the EMT system.
    It encapsulates the Emtracker Class in a QObject making it possible to invoke EMT functions.
